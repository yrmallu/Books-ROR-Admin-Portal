...
#   Mayor.create(name: 'Emanuel', city: cities.first)
    User.create(email: 'webadmin@cuelogic.co.in', password: '12345678', password_confirmation: '12345678', role_id: 1)
	User.create(email: 'schooladmin@cuelogic.co.in', password: '12345678', password_confirmation: '12345678', role_id: 2)
	User.create(email: 'teacher@cuelogic.co.in', password: '12345678', password_confirmation: '12345678', role_id: 3)
