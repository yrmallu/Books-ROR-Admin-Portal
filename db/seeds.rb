...
#   Mayor.create(name: 'Emanuel', city: cities.first)
	...
	Accessright.create!([{name: 'Create School Admin'},{name: 'Update School Admin'},{name: 'Delete School Admin'},{name: 'View School Admin'},{name: 'Create Teacher'},{name: 'Update Teacher'},{name: 'Delete Teacher'},{name: 'View Teacher'},{name: 'Create Student'},{name: 'Update Student'},{name: 'Delete Student'},{name: 'View Student'},{name: 'Create School'},{name: 'Update School'},{name: 'Delete School'},{name: 'View School'},{name: 'Can Manage Student'},{name: 'Create Class'},{name: 'Update Class'},{name: 'Delete Class'},{name: 'View Class'},{name: 'Create License'},{name: 'Update License'},{name: 'Delete License'},{name: 'View License'}])
