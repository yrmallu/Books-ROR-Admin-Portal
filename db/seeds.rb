...
#   Mayor.create(name: 'Emanuel', city: cities.first)
	...
	update_book_right = Accessright.create!(name: 'Update Accessright')
	view_book_right = Accessright.create!(name: 'View Accessright')
	delete_book_right = Accessright.create!(name: 'Delete Accessright')
